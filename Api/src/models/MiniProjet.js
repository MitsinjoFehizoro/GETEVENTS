module.exports = (sequelize, DataTypes) => {
  return sequelize.define("MiniProjet", {
    ...
    membres: {
      type: DataTypes.STRING,
      get() {
        return this.getDataValue("membres").split(",");
      },
      set(membres){
        this.setDataValue("membres", membres.join())
      },
      validate : {
        isMembresValid(value){
          if(!value){
            throw new Error("Les membres d'un mini-projet doit avoir au moins un etudiant.")
          }
        }
      }
    },
