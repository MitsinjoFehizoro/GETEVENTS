...
import app.getevents.ui.composable.BaseStyleWhite
            ...
            Box(
                ...
                Column(
                    ...
                    Row(
                        ...
                        PrimaryButton(text = "SignUp", onClick = { navController.navigate(Route.SignUpScreen.itineraire)})
                        Spacer(modifier = Modifier.width(16.dp))
                        SecondaryButton(text = "Login", onClick = { navController.navigate(Route.LoginScreen.itineraire)} )
